...
echo ""
echo "For custom portrait sizes (lower VRAM):"
echo "  --height 1024 --width 640  # Medium quality, ~25GB"
echo "  --height 768 --width 512   # Lower quality, ~18GB"
echo ""
echo "For higher quality portrait:"
echo "  --height 1536 --width 896  # High quality, ~40GB+"
