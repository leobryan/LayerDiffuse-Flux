...
⚠️ **重要**: 所有尺寸必须能被 **128** 整除（Flux VAE 16倍下采样 × TransparentVAE 8倍下采样）

| 长宽比 | 推荐尺寸 | 说明 |
|--------|---------|------|
| 1:1 (方形) | 1024x1024 | 标准设置 |
| 竖屏 | 1280x768 | 适合手机竖屏内容 (5:3 比例) |
| 竖屏 | 1024x640 | 中等竖屏 (8:5 比例) |
| 竖屏 | 768x512 | 显存受限时使用 (3:2 比例) |
| 横屏 | 1024x640 | 适合横屏视频 (16:10 比例) |
| 横屏 | 768x512 | 中等横屏 (3:2 比例) |
| 横屏 | 512x384 | 显存受限时使用 (4:3 比例) |
...
💡 **技巧**:
- 如果显存不足，使用 768x512（竖屏或横屏）
- 所有自定义尺寸必须是 128 的倍数，否则会报错
